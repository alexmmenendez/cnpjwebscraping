package br.com.cnpjwebscraping.solver.deathbycaptchav2.json;
...
/**
 * Test class. This file is not formally a member of the captcha.org.json library.
 ...
 */
		...
		try {
			...
			j = XML.toJSONObject("<![CDATA[This is a collection of test patterns and examples for captcha.org.json.]]>  Ignore the stuff past the end.  ");
			...
			System.out.print("DeathByCaptchaException: ");
			try {
				a = new JSONArray("[\n\r\n\r}");
				System.out.println(a.toString());
			} catch (Exception e) {
