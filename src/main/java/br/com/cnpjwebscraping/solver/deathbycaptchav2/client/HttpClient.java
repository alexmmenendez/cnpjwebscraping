...
import br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception;
...
public class HttpClient extends Client
{
            ...
            throws IOException, Exception
        {
            ...
            while (deadline.after(new Date()) && null != url && null == response) {
                ...
                try {
                    ...
                    throw e;
                } catch (br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception e) {
                    throw e;
                } catch (java.lang.Exception e) {
        ...
        throws IOException, br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception
    {
     ...
     /**
     * @see br.com.cnpjwebscraping.solver.deathbycaptchav2.client.Client#upload for noCaptchas by Token
     */
