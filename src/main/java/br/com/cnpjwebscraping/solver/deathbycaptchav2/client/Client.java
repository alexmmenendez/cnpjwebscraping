...
abstract public class Client
{
    ...
    final static public int POLLS_INTERVAL_FIVE = 5;
     ...
     * @throws IOException IO exception
     * @throws br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception Own exception
     */
    ...
    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#upload
    ...
    public Captcha upload(File f)
        throws IOException, FileNotFoundException, br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception
    {
    ...
    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#getCaptcha
    ...
    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#getText
     * @param captcha CAPTCHA object
     * @throws IOException IO exception
     * @throws br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception Own exception
    ...
    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#report
     * @param captcha CAPTCHA object
     * @throws IOException IO exception
     * @throws br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception Own exception
    ...
    public Captcha decode(byte[] img, String challenge, int type, byte[] banner, String banner_text, String grid, int timeout)
        throws IOException, br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception, InterruptedException
    {
    ...
    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#decode(byte[], int)
    ...
    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#decode
     * @param st CAPTCHA image stream
     * @param timeout Solving timeout (in seconds)
     * @param grid grid
     * @param timeout Solving timeout (in seconds)
    ...
    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#decode(InputStream, int)
     * @param st stream
     * @throws IOException IO exception
     * @throws br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception Own exception
     * @throws InterruptedException interruption error
    ...
    public Captcha decode(File f, int timeout)
        throws IOException, FileNotFoundException, br.com.cnpjwebscraping.solver.deathbycaptchav2.exception.Exception, InterruptedException
    {
        return this.decode(this.load(f), timeout);
    }

    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#decode(File, int)
    ...
    /**
     * @see br.com.docket.crawler.consumer.solver.provider.deathbycaptchav2.client.Client#decode(String, int)
